...
class MinKPlusPlusAttack(MinKProbAttack):
    ...
    def compute_score(self, sample_stats):
        ...
        # Cast to fp32 before .numpy(): bf16 tensors don't support numpy()
        # conversion. The other two terms already do this; sigma was the
        # missing one (caused TypeError under bf16 eval).
        scores = (
